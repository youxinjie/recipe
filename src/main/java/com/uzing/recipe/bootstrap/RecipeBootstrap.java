package com.uzing.recipe.bootstrap;

import com.uzing.recipe.domain.*;
import com.uzing.recipe.repositories.CategoryRepository;
import com.uzing.recipe.repositories.RecipeRepository;
import com.uzing.recipe.repositories.UnitOfMeasureRepository;
...
/**
 * Created by Xinjie on 2018/10/27 4:11 PM.
 */
@Slf4j
@Component
@Profile("default")
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Loading BootStrapMySQL Data");
    }
